...
class AgenticPersonalizedNewsDigestSession(Base):
    __tablename__ = "personalized_news_digest_sessions"
...
class AgenticPersonalizedNewsDigestItem(Base):
    __tablename__ = "personalized_news_digest_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("personalized_news_digest_sessions.id"))
